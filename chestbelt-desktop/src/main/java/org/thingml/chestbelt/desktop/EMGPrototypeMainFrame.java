 ...
 * @author ffl
 */
public class EMGPrototypeMainFrame extends javax.swing.JFrame implements ChestBeltListener, BitRateListemer {
   ...
   // protected GraphBuffer becg = new GraphBuffer(1000);
    ...
    private void initComponents() {
        ...
        jPanelEMG = new LineGraphPanel(brmsa, "EMG RMS Value (Belt Channel A)", 0, 4096, 512, new java.awt.Color(0, 204, 51));
